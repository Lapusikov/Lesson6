package ru.mirea.laptinski_d_a.securesharedpreferences;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            // Получаем имя поэта
            String actorName = secureSharedPreferences.getString("secure", "Просто аватар");
            ...
            editor.putString("secure", "Просто аватар");
            editor.putString("avatar", "avatar");
            editor.apply();

            // Получаем имя файла изображения из SharedPreferences
            String photoName = secureSharedPreferences.getString("avatar", "avatar");
